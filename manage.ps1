...
$ADDON_VERSION = Invoke-Expression -Command "python -c ""import os;import sys;content={};f=open(r'$($script_dir)/ash/__init__.py');exec(f.read(),content);f.close();print(content['__version__'])"""
